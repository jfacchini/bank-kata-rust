...
pub struct Account<'a> {
    transaction_repository: &'a dyn TransactionRepository
}

impl<'a> Account<'a> {
    pub fn new(transaction_repository: &'a dyn TransactionRepository) -> Self {
        Self {
...
mod tests {
    ...
    fn add_a_new_deposit_in_transaction_repository() {
        ...
        let account = Account::new(&transaction_repository);
